...
namespace Eventos.IO.Domain.Eventos
{
    ...
    {
        public Evento(string nome, DateTime dtInicio, DateTime dtFim, bool gratuito, decimal valor, bool online, string nomeEmpresa)
        {
        ...
        public virtual ICollection<Tags> Tags { get; private set; }
        ...
        {
            RuleFor(c => c.Nome).NotEmpty().WithMessage("Nome do evento precisa ser fornecido").Length(2, 150)
                .WithMessage("Nome do evento precisa ter entre 2 e 150 caracteres");
        }
        ...
        {
            if (Online)
                RuleFor(c => c.Endereco).Null().When(c => c.Online).WithMessage("Evento nao deve possuir um endereco se for online");

            if (!Online)
                RuleFor(c => c.Endereco).NotNull().When(c => !c.Online).WithMessage("Evento deve possuir um endereco");
        }
        private void ValidarNomeEmpresa()
        {
            RuleFor(c => c.NomeEmpresa).NotEmpty().WithMessage("Nome do organizador precisa ser fornecido").Length(2, 150)
                .WithMessage("Nome do organizador precisa ter entre 2 e 150 caracteres");
        }
        ...
        {
            public static Evento NovoEventoCompleto(Guid id, string nome, string descCurta, string descLongs, DateTime dtInicio,
